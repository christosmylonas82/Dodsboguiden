...
export const DEFAULT_CHECKLIST: ChecklistTemplateItem[] = [
  ...
  // Efter förrättningen
  {
    ...
    moreInfo:
      'Skicka bouppteckningen tillsammans med kopia av testamente (om det finns), äktenskapsförord, och kallelsebevis. Adress: Skatteverket, Bouppteckningssektionen, 871 87 Härnösand. Skicka inom en månad efter förrättningen.',
