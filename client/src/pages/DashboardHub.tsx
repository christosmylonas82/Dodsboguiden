        ...
        {PHASES.map((phase) => {
          ...
          return (
            <Link
              ...
              className="flex flex-col rounded-xl border border-card-accent-border bg-card-accent p-6 shadow-sm transition duration-150 hover:-translate-y-0.5 hover:shadow-md"
            >
